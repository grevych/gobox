				...
				return []map[string]interface{}{
					{
						...
						"attributes.http.scheme":               string("http"),
					...
					},
					{
						...
						"attributes.http.flavor":                  "1.1",
						"attributes.http.method":                  "GET",
						"attributes.http.response_content_length": int64(2),
						"attributes.http.status_code":             int64(200),
						"attributes.http.url":                     differs.AnyString(),
						"attributes.net.peer.name":                "127.0.0.1",
						"attributes.net.peer.port":                differs.AnyInt64(),
						"endTime":                                 differs.AnyString(),
						"name":                                    "HTTP GET",
						"parent.remote":                           false,
