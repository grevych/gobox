...
// ServiceActivity is a task runner to switch a logger level
// for a service through command line.
...
// New creates a new service activity runner that listens for the given
// os signal and attempts to switch the level of the given logger to debug mode.
...
// Run runs the log level switcher as a service activity
...
// Close finishes the service activity
